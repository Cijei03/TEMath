...
namespace tem
{
	namespace intern
	{
		...
		constexpr mat3<T> mat3<T>::operator*(const mat3<T>& a) const
		{
			return mat3<T>
				(
					vec3<T>
					(
						this->Data[0][0] * a.Data[0][0] + this->Data[0][1] * a.Data[1][0] + this->Data[0][2] * a.Data[2][0],
						this->Data[0][0] * a.Data[0][1] + this->Data[0][1] * a.Data[1][1] + this->Data[0][2] * a.Data[2][1],
						this->Data[0][0] * a.Data[0][2] + this->Data[0][1] * a.Data[1][2] + this->Data[0][2] * a.Data[2][2]
					),
					vec3<T>
					(
						this->Data[1][0] * a.Data[0][0] + this->Data[1][1] * a.Data[1][0] + this->Data[1][2] * a.Data[2][0],
						this->Data[1][0] * a.Data[0][1] + this->Data[1][1] * a.Data[1][1] + this->Data[1][2] * a.Data[2][1],
						this->Data[1][0] * a.Data[0][2] + this->Data[1][1] * a.Data[1][2] + this->Data[1][2] * a.Data[2][2]
					),
					vec3<T>
					(
						this->Data[2][0] * a.Data[0][0] + this->Data[2][1] * a.Data[1][0] + this->Data[2][2] * a.Data[2][0],
						this->Data[2][0] * a.Data[0][1] + this->Data[2][1] * a.Data[1][1] + this->Data[2][2] * a.Data[2][1],
						this->Data[2][0] * a.Data[0][2] + this->Data[2][1] * a.Data[1][2] + this->Data[2][2] * a.Data[2][2]
					)
				);
		}
		...
		constexpr vec3<T> mat3<T>::operator*(const vec3<T>& a) const
		{
			return vec3<T>
				(
					this->Data[0][0] * a[0] + this->Data[0][1] * a[1] + this->Data[0][2] * a[2],
					this->Data[1][0] * a[0] + this->Data[1][1] * a[1] + this->Data[1][2] * a[2],
					this->Data[2][0] * a[0] + this->Data[2][1] * a[1] + this->Data[2][2] * a[2]
				);
		}
