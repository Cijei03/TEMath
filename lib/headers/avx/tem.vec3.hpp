...
namespace tem::avx::intern
{
    ...
    public:
        ...
        T z;
    public:
        TEM_AVX_SIMD constexpr vec3(const T x, const T y, const T z);
        TEM_AVX_SIMD constexpr vec3(const T v);

        TEM_AVX_SIMD constexpr vec3(const vec2<T>& v, const T z);
        TEM_AVX_SIMD constexpr vec3(const T x, const vec2<T>& v);

        TEM_AVX_SIMD constexpr vec3() = default;
        TEM_AVX_SIMD ~vec3() = default;
        ...
        TEM_AVX_SIMD TEM_NODISCARD constexpr bool operator<(const vec3<T>& a) const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr bool operator<=(const vec3<T>& a) const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr bool operator==(const vec3<T>& a) const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr bool operator>=(const vec3<T>& a) const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr bool operator>(const vec3<T>& a) const;

        TEM_AVX_SIMD TEM_NODISCARD constexpr vec3<T> operator+(const vec3<T>& a) const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr vec3<T> operator+=(const vec3<T>& a) const;
        ...
        TEM_AVX_SIMD TEM_NODISCARD constexpr vec3<T> abs() const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr vec3<T> normalize() const;
        TEM_AVX_SIMD TEM_NODISCARD constexpr T length() const;

        TEM_AVX_SIMD static constexpr T dot(const vec3<T>& a, const vec3<T>& b);
        TEM_AVX_SIMD static constexpr T distance(const vec3<T>& a, const vec3<T>& b);
        TEM_AVX_SIMD static constexpr vec3<T> cross(const vec3<T>& a, const vec3<T>& b);
    };
